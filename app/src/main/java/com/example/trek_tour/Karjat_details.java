...
public class Karjat_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView myTextView = findViewById(R.id.KarjatPrice); // the TextView to store the value in
        ...
        BookTrek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Karjat_details.this, acc.class); // create the Intent to start the next activity
